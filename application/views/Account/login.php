...
<section class="small-section bg-dark-lighter">
    <div class="relative container align-left">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <h1 class="hs-line-11 font-alt mb-20 mb-xs-0">Login/Registration</h1>
...
<div class="login-registration-page-area" style="padding: 20px 0;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                if ($next_link === 'checkoutInit') {
                    ...
                    <h5  class="text-center">
                        <a href="<?php echo site_url("CartGuest/checkoutInit"); ?>" class="btn  btn btn-mod">
            ...
            ?>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="background: white;padding-bottom: 15px;">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background: white;padding-bottom: 15px;">
                <div class="login-registration-field">
