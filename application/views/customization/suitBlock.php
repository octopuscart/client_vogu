...
<div class="fontview_custom customization_block animated zoom "  ng-if="screencustom.view_type == 'front'" >
    ...
    if ($tuxedotype == '1') {
        ...
        ?>
        <img src="<?php echo custome_image_server; ?>/jacket/output/overlay/shirt3.png" class="fixpos animated" >
        <?php
    }
    ?>


    <img src="<?php echo custome_image_server; ?>/jacket/output/{{screencustom.productobj.folder}}/sleeve_style20001.png" class="fixpos animated" style="">
    <!--<img src="<?php echo custome_image_server; ?>/jacket/output/overlay/sleeve_new_olverlay.png" class="fixpos animated" >-->
    <img src="<?php echo custome_image_server; ?>/jacket/output/{{screencustom.productobj.folder}}/pant_suit_model0001.png" class="fixpos animated " style="margin-top: -12px;">
    ...
    <img src="<?php echo custome_image_server; ?>/jacket/output/{{screencustom.productobj.folder}}/sleeve_style30001.png" class="fixpos animated" style="">
    ...
    <img src="<?php echo custome_image_server; ?>/jacket/output/overlay/bodysleeveoverlay.png" class="fixpos animated">

    <img src="<?php echo custome_image_server; ?>/jacket/output/overlay/hands3.png" class="fixpos animated">
